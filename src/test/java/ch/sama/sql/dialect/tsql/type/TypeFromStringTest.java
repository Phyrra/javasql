...
public class TypeFromStringTest {
    @Test
    ...
    public void smallIntType() {
        assertEquals("smallint", TYPE.SMALL_INT_TYPE.getString());
    }

    @Test
    public void bigIntType() {
        assertEquals("bigint", TYPE.BIG_INT_TYPE.getString());
    }
